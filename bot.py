...
persos = {"Diluc" : ["Cheveux rouges", "Mondstadt", "Grand", "Manteau", "Gants", "Bien habillé", "Ceinture", "Pyro", "Claymore", "Vin", "Riche", "Blazé"],
          ...
          "Dottore" : ["Fatui", "Le Médecin", "Sumeru", "Académie", "Clones", "Masque", "Tenue blanche", "Cheveux bleus","Cobayes"],
          ...
          "Cyno":["Électro","Lance","Sumeru","Désert","Cheveux blancs","Hermanubis","Loup","Justice","Matra","Général"],
          ...
          "Xingqiu" : ["Hydro","Épée à 1 main", "Cheveux bleus", "Guhua", "Livres", "Feiyun","Bien habillé","Taille moyenne","Homme"]
          }
